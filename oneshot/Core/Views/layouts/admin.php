<?= render('Core::layouts/_head', ['layout_section' => 'admin']) ?>
...
<div class="drawer lg:drawer-open">
    ...
    <div class="drawer-side z-40">
        ...
        <aside class="w-64 min-h-full bg-base-200 flex flex-col border-r border-base-300">
            ...
            <!-- Logo -->
            <div class="h-14 flex items-center px-4 gap-2 border-b border-base-300 shrink-0">
                ...
                <span class="text-lg font-extrabold tracking-tight leading-none"><?= esc(option('general.app_name', 'OneShot')) ?></span>
                <?php endif; ?>
                <span class="badge badge-primary badge-xs ml-auto"><?= __('core.admin_badge', 'Admin') ?></span>
            </div>

            <!-- Main nav -->
            <nav class="flex-1 overflow-y-auto py-3">
                <?= render('Core::layouts/_nav', ['navItems' => config('Nav')->admin]) ?>
            </nav>
