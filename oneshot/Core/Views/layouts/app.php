...
<div class="drawer lg:drawer-open">
    ...
    <div class="drawer-content flex flex-col min-h-screen">
        ...
        <header class="sticky top-0 z-30 flex items-center h-14 px-4 bg-base-100 border-b border-base-200 gap-3">
            ...
            <label for="app-drawer" class="btn btn-ghost btn-sm btn-square">
    ...
    <div class="drawer-side z-40">
        ...
        <aside class="w-64 min-h-full bg-base-200 flex flex-col border-r border-base-300">
            ...
            <!-- Bottom nav -->
            <div class="border-t border-base-300 px-3 py-2 shrink-0 flex items-center gap-2 relative">
                ...
                <?= render('Notifications::layouts/_bell') ?>
                <div class="tooltip tooltip-left" data-tip="<?= __('core.profile', 'Profile') ?>">
                    <a href="<?= route_to('app.profile') ?>" class="btn btn-ghost btn-xs btn-square <?= str_contains(current_url(), '/app/profile') ? 'btn-active' : '' ?>">
