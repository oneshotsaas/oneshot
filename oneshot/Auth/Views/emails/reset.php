...
<head>
    ...
    <style>
        ...
        .btn { display: inline-block; background-color: #ef4444; color: #ffffff !important; text-decoration: none;
...
<span style="display:none;font-size:1px;color:#f4f4f5;max-height:0;max-width:0;opacity:0;overflow:hidden;">
    Password reset requested — link expires in {expires}
</span>
...
<div class="wrapper">
    <div class="container">
        ...
        <div class="body">
            ...
            <p class="text"><?= __('auth.email_reset_body', 'We received a request to reset the password for your account.') ?></p>

            <div class="btn-wrap">
                <a href="{link}" class="btn"><?= __('auth.email_reset_button', 'Reset Password') ?></a>
            </div>
            ...
            <p class="expires"><?= __('auth.email_reset_expires', 'This link expires in {expires}.') ?></p>

            <hr class="divider">

            <p class="ignore"><?= __('auth.email_reset_ignore', "If you didn't request a password reset, no action is needed.") ?></p>
        </div>
        <div class="footer">
            <p>{app_name}</p>
        </div>
